...
class CreateCaseClassSlimTest extends AnyFlatSpec with Matchers {
  val spark = SparkSession.builder().master("local[*]").getOrCreate()
  spark.sparkContext.setLogLevel("WARN")
  import spark.implicits._

  it should "Create case class for EPC Slim" in {
    ...
    val baseUri = getClass.getResource("/CreateCaseClassSlim/epc").getPath
    ...
    CreateCaseClassSlim.run(spark, sourceUri, destinationUri)
